...
content = content.replace(
  /<button class="btn-hero-outline" onclick="document\.getElementById\('section-playbook'\)\.scrollIntoView\(\{behavior:'smooth'\}\)">[\s\S]*?Jump to Playbook[\s\S]*?<\/button>/,
  ''
);

// 2. Nav Bar
const navOriginal = `      <a href="#dashboard-setup">Dashboard Setup</a>
      <a href="#section-materials">Materials</a>
      <a href="#section-playbook">Playbook</a>`;
const navReplacement = `      <a href="#dashboard-setup">Dashboard Setup</a>
...
// 3. Footer Links
const footerOriginal = `      <a href="#section-commission">Commission Structure</a>
      <a href="#section-materials">Materials Library</a>
      <a href="#section-playbook">Playbook</a>`;
const footerReplacement = `      <a href="#section-commission">Commission Structure</a>`;
content = content.replace(footerOriginal, footerReplacement);
...
content = content.replace(/<!-- ==============================\s*MATERIALS LIBRARY\s*============================== -->[\s\S]*?<!-- ==============================\s*FINAL CTA\s*============================== -->/, '<!-- ==============================\n     FINAL CTA\n     ============================== -->');
...
content = content.replace(jsOriginal, jsReplacement);
