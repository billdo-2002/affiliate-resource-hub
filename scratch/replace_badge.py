...
old_block = """<div class="stagger-enter hero-badge" style="display: inline-flex; align-items: center; justify-content: center; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.15); border-radius: 999px; padding: 10px 20px; font-size: 14px; color: #fff; margin-bottom: 24px; animation-delay: 0.1s; box-shadow: none;">
      <span class="badge-label" style="font-style: italic; font-weight: 600;">TrueProfit MCP</span>
      <span class="badge-divider" style="font-style: italic; font-weight: 400; color: rgba(255,255,255,0.6); white-space: pre;"> : </span>
      <span class="badge-sub" style="font-style: italic; font-weight: 400; color: rgba(255,255,255,0.6);">TrueProfit x LLMs</span>
    </div>"""
